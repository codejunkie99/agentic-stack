"""Area chart — stacked area chart positioned within bounds.

Thin wrapper around deck.add_chart() with stacked_area type.
"""
...
def render(deck, slide, data, bounds, **kwargs):
    ...
    deck.add_chart(slide, "stacked_area", categories, series,
