...
`/Users/okyeboah/dev-repo/agentic-stack/.stele-context`. The CLI default (`~/.stele-context`) is a cross-project
catch-all — never use it. zsh resolves `STELE_CONTEXT_STORAGE_DIR` to the
nearest enclosing store; any other shell passes
`--storage-dir /Users/okyeboah/dev-repo/agentic-stack/.stele-context` before the subcommand.
...
- Stale results: `stele-context detect`, then `stele-context --storage-dir /Users/okyeboah/dev-repo/agentic-stack/.stele-context index /Users/okyeboah/dev-repo/agentic-stack`
